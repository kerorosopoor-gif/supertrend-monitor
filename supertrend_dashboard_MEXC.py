...
with st.form("custom_form"):
    ...
    submitted = st.form_submit_button('✅ 建立此自訂通知')
    if submitted:
...
st.caption("公式：Total Profit = (0.5 × 1.5R) + (0.5 × Trailing Stop R) | 當價格觸及後回落觸發止損的實際總獲利")
